"""Anthropic provider implementation and helpers."""
...
from . import BaseProvider, ProviderStreamChunk


class UnsupportedContentBlockError(ValueError):
    """Raised when a request includes a content block unsupported by Anthropic."""
...
__all__ = ["AnthropicProvider", "UnsupportedContentBlockError"]
